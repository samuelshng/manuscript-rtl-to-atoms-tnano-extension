...
\TODO{Clocking background (and the simplest \& most area efficient clocking layout being row-wise clocking), and how this necessitates deep pipelines.} \TODO{Useful snippet to transplant here: a trait that is common among \gls{fcn} technologies in consideration of operational reliability and in order to facilitate signal propagation.}
